...
extraction_config = [
    {
        'type': 'simple',
        'tags': ['BenchmarkSource', 'SourceWeight', 'Currency']  # 3 simple tags
    },
    {
        'type': 'nested',  # config_index = 0
        'parent_tag': 'Portfolio',
        'nested_tags': ['SecurityId', 'Weight'],
        'output_columns': ['Security_ID', 'Portfolio_Weight']
    },
    {
        'type': 'nested',  # config_index = 1  
        'parent_tag': 'Risk',
        'nested_tags': ['Factor', 'Exposure', 'Volatility'],
        'output_columns': ['Risk_Factor', 'Factor_Exposure', 'Vol_Estimate']
    }
]
...
correspondence_groups = [
    {
        'type': 'simple',
        'tags': ['BenchmarkSource', 'SourceWeight'],  # Only these 2 of the 3 simple tags must match
        'require_all_match': True
    },
    {
        'type': 'nested',
        'config_index': 1,  # Apply to the 'Risk' nested config (second nested = index 1)
        'tags': ['Factor', 'Exposure'],  # Only these 2 of the 3 nested tags must match
        'require_all_match': True
    }
]
